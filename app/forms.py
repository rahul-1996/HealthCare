...
from wtforms.validators import ValidationError , Required , Email , NumberRange
from app.models import db, User , Patient


class PatientDetails(Form) :
  name = TextField("Patient Name", [Required("Please enter patient name.")])
  phone = IntegerField("Phone Number") 
  medicines = TextField("Enter medication")
  time = TextField("Enter time in 24 hour format")
